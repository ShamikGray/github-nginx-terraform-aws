...
Attached the below instructions to setup the s3 bucket before triggering the terraform init/plan/apply.
...
- Optionally, configure additional settings like versioning, logging, tags, etc. as per the requirements.
- Click "Next".
...
The S3 bucket "project-terraform-state-backup" is now created.
